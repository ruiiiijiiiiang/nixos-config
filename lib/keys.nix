{
  ssh = {
    ...
    windows = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIN4IAcvPUaBJYGKYLD3FfeNcIpYeN2OzgJ9k/+3tn849 rui@windows"
    ];
    pi = [
    ...
    termix = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAII3Bj5HKldVNY41t63qfu1+DoLDlu5hK2hJMv+aSHiUo termix";
  };
